...
path('adminListAnnonce/', login_required(admin.ListAllAnnonce.as_view()), name='adminListAnnonce'),
...
# path('user_profile/', login_required(instructor.user_profile), name='user_profile'),
# path('create_profile/', login_required(instructor.create_profile), name='create_profile'),
